...
def generate_pdf_report(report_data: dict) -> bytes:
    ...
    story.append(Paragraph(
        "Так как ИИ‑модель сервиса не проверяет рекламу на недостоверность (обман), рекомендуем дополнительно "
        "самостоятельно оценить объявление на предмет недостоверности. В конце отчёта приведены критерии такой оценки.",
        normal_style
    ))
