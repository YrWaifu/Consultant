...
Для признания информации рекламой необходимо ее соответствие признакам рекламы, перечисленных в пункте 1 статьи 3 Федерального закона "О рекламе". Одним из таких является - адресация неопределенному кругу лиц, под которым понимаются те лица, которые не могут быть заранее определены в качестве получателя рекламной информации и конкретной стороны правоотношения, возникающего по поводу реализации объекта рекламирования.
...
В свою очередь, наличие факта размещения информации за плату не входит в перечень признаков рекламы, перечисленных в  пункте 1 статьи 3 Федерального закона "О рекламе".
...
Ссылка на источник: 
-	Федеральный закон от 13.03.2006 N 38-ФЗ (ред. от 31.07.2025) "О рекламе" Приказ ФАС России от 14.11.2023 N 821/23 "Об утверждении руководства по соблюдению обязательных требований "Понятие рекламы"
